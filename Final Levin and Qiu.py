...
dde_camp2.initproblem(no_vars=6, no_cons=9, nlag=1, nsw=0, t0=plyt_added, t1=250.0, initstate=ddeist, c=ddecons, otimes= arange(plyt_added, 250.0, 0.1), grad=ddegrad, storehistory=ddesthist)
